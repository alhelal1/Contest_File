...
ll Q(ll idx,ll s,ll e,ll i,ll j)
{
    if(s==i and e==j)
    {
        return tree[idx];
    ...
    {
        ll p1=Q(idx*2,s,mid,i,mid);
        ll p2=Q(idx*2+1,mid+1,e,mid+1,j);
        return min(p1,p2);
    }
}
int main()

       ...
       rep(j,n)
       {
           ...
           if(m==1)
           {
               ...
               for(int i=0;i<aa-1;i++)
               {
                   ...
                   ///a,b theke c,d  c<a<d  or c<b<d;
                   if((v[i].first<a and a<v[i].second)  or (v[i].first<b and b<v[i].second))
                   {
                       vv[i+1].pb(aa);
                   ...
                   if((a<v[i].first and v[i].first<b)  or (a<v[i].second  and v[i].second<b))
                   {
                       vv[aa].pb(i+1);

...
ll ar[100005];
//ll ar1[100005];
ll a=0,b=0,c=0,r=0,rr=0,t=0,ks=0,n,m;
//string s;

vector<long long>v[1000005],cost[100005];

vector<long long > vv;


ll dfs(ll idx,ll pre)
{
...
int main()
{
    ...
    rep(i,n-1)
    {
        ...
        v[a].push_back(b);
        cost[a].push_back(c-1);
        v[b].push_back(a);
        cost[b].push_back(c-1);
    }

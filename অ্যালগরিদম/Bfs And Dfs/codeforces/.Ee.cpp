...
///string to int
//mplate <class T> T extract(string s, T ret) {stringstream ss(s); ss >> ret; return ret;}/// extract words or numbers from a line
//mplate<class T> string itos(T n){ostringstream ost;ost<<n;ost.flush();return ost.str();}///NOTES:toString(
// stoi(string s){ll r=0;istringstream sin(s);sin>>r;return r;}///NOTES:toInt(
//uble toDouble(string s){double r=0;istringstream sin(s);sin>>r;return r;}
   ...
   // Fast;
    ...
    while(n--)
    {
        ...
        else
        {
            ...
            if(aa<=cc and bb<=cc)cout<<"Steven\n";
            else cout<<"Mikael\n";

...
char ar[505][505]; ll vis[505][505],vis1[505][505],arr[505][505];
//ll r=0,rr=0,res=0,a=0,b=0,c=0,n,m,aa=0;
...
ll dfs(ll i,ll j)
{
    ...
    while(!Q.empty())
    {
        ...
        rep(i,4)
        {
            ...
            if(aa1<0 or aa1>=n or bb1<0 or bb1>=m or vis[aa1][bb1]==1 or ar[aa1][bb1]=='#')continue;
            Q.push(aa1);
            Q.push(bb1);
            if(ar[aa1][bb1]=='C')c++;
...
ll dfs1(ll i,ll j,ll c)
{
    ...
    while(!Q.empty())
    {
        ...
        rep(i,4)
        {
            ll aa1=aa+row[i];
            ll bb1=col[i]+bb;
            if(aa1<0 or aa1>=n or bb1<0 or bb1>=m or vis1[aa1][bb1]==1 or ar[aa1][bb1]=='#')continue;
            Q.push(aa1);
            Q.push(bb1);
           arr[aa1][bb1]=c;
            vis1[aa1][bb1]=1;
